...
describe('columnFamily', () => {
  it('should place the constructors', () => {
  ...
  it('should place one type of each family, which is what the built lookup has to get right', () => {
...
describe('isIntegerColumn', () => {
  it('should read a `Number` or `BigInt` with no scale as the BIGINT it is stored as', () => {
  ...
  it('should read a declared column type over the logical one', () => {
...
describe('isAutoIncrement', () => {
  ...
  // A key that states its width is still generated by the database; one that states how it is filled is
  // not. The schema AST answers the same.
