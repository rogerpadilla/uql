...
**[UQL](https://uql-orm.dev)** is the smartest ORM: best type-safety, serializable queries, no codegen, and unified API across PostgreSQL, MySQL, SQLite, MariaDB, and MongoDB.
